# This file was created by: Bennett Anderson 9/25

'''
Goals - Create game of "rock, paper, scissors" which utilizes turtle graphics
...
# repeat steps shown above for the rest of player and cpu images
def show_paper(x,y):
...
# define starting image postions within window
show_rock(-300,0)
show_paper(0,0)
show_scissors(300,0)

# establish visual representation of win, lose, or tie
def mouse_pos(x, y):
    print(cpu_select())
